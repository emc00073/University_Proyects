...
public:    
	...
	*/
	virtual bool intersects(Vect2d& c, Vect2d& d, float& s, float& t);

	/**
	* @brief Determines whether this segment intersects a line.
	*/
	virtual bool intersects(const Line& l, Vect2d& res);

	/**
	* @brief Determines whether this segment intersects a ray.
	*/
	virtual bool intersects(const RayLine& r, Vect2d& res);

	/**
	* @brief Determines whether this segment intersects an other segment.
	*/
	virtual bool intersects(const SegmentLine& r, Vect2d& res);

	/**
	* @brief Determines the distance between a point and a this segment.
	*/
	double distPointSegment(const Vect2d& v);
};
