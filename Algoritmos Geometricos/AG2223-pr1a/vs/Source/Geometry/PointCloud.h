...
public:
	...
	*/
	...
	/**
	* @brief Returns the points that minimizes the distance to a specific point from the cloud.
	*/
	Point centralPoint(Point& p);

	/**
	* @brief Returns the points that maximizes the abscissa.
	*/
	Point maxAbscissa();

	/**
	* @brief Returns the points that minimizes the abscissa.
	*/
	Point minAbscissa();

	/**
	* @brief Returns the points that maximizes the ordinate.
	*/
	Point maxOrdinate();

	/**
	* @brief Returns the points that minimizes the ordinate.
	*/
	Point minOrdinate();
